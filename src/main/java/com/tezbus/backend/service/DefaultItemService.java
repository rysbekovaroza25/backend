...
public class DefaultItemService implements ItemService {
    ...
    public List<ReadItemDto> getAll(ItemSearchRequest itemSearchRequest, Pageable pageable) {
        ...
        return items.stream().map(it -> itemMapper.toReadItemDto(it)).collect(Collectors.toList());
    }
